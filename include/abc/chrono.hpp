...
template <typename ClockT, typename TRep = typename ClockT::rep, typename TPeriod = typename ClockT::period,
    typename TDuration = typename ClockT::duration, typename TTimepoint = typename ClockT::time_point>
